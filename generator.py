...
class Generator:
    ...
    def __init__(self, sentences, chain_len = 2):
       ...
       # Args:
         ...
         #   chain_len (int): max number of words to look back when generating a new sentence
	...
	# Given a list of sentences returns a list of tokens that delimits where sentences start and end with <s> and </s>.
    @staticmethod
    ...
    # Stitch sentence parts together with proper spacing. For example, for punctuations, contractions etc.
    @staticmethod
    def stitch(sentence):
        result = []
        stack = []
...
sentences = []
sentences.append("I awoke one morning as the sun caught my eye")
sentences.append("lasting only a moment the world fell into silence")
sentences.append("As i looked upon the seventh seal was broken and the rivers ran red")
chain_length = 2
